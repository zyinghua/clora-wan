...
# Text-to-video with prompt ablation (search over block id × block size)
PROMPT = "A video shot of a tiger."
NEGATIVE_PROMPT = "色调艳丽，过曝，静态，细节模糊不清，字幕，风格，作品，画作，画面，静止，整体发灰，最差质量，低质量，JPEG压缩残留，丑陋的，残缺的，多余的手指，画得不好的手部，画得不好的脸部，畸形的，毁容的，形态畸形的肢体，手指融合，静止不动的画面，杂乱的背景，三条腿，背景人很多，倒着走"
ABLATION_PROMPT = "A video shot of a bunny."
...
for ablation_block_size in ablation_range.keys():
    for ablation_block_id in ablation_range[ablation_block_size]:
        ...
        out_name = f"video_wan_out_ablation_{ablation_block_size}-{ablation_block_id}.mp4"
