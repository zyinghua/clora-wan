...
ablation_tasks =[
    ...
    # {
    #     "category": "content",
    #     "base_prompt": "A video of a glass sphere on a table.",
    #     "ablation_prompt": "A video of a glass cube on a table."
    # },
    {
        "category": "content",
        "base_prompt": "A video of a sports car driving.",
        "ablation_prompt": "A video of a pickup truck driving."
    },
    {
        "category": "content",
    ...
    {
        "category": "motion",
        "base_prompt": "A video of a coffee mug on a desk, camera panning left.",
        "ablation_prompt": "A video of a coffee mug on a desk, camera panning right."
    },
    {
        "category": "motion",
